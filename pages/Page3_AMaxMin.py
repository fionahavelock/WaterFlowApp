                    ...
                    dbc.Card([
                        ...
                        html.Br(),
                            dbc.Card([
                                dbc.CardBody([
                                    html.Div([
                                        html.P(["The Gringorten formula is a statistical distribution that helps represent annual maximum frequencies. The Gringorten formula shows the probability of a high flow event happening. This plot shows the probabilty as a return period in years."]),
                                        html.Br(),
                        ...
                        html.Br(),
                            dbc.Card([
                                dbc.CardBody([
                                    html.Div([
                                        html.P(["This Gringorten formula plot shows the probabilty as percentage."]),
                                        html.Br(),
