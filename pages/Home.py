        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Div([
                    html.P("References:"),
                    html.Br(),
                    html.P("As this project was a hands-on experience, some of the fundamental knowledge I used to begin this project was not relevant to the final thesis. For this reason, I have provided an additional list of references here. These references helped me understand important concepts in hydrology and programming. "),
                    html.Br(),
