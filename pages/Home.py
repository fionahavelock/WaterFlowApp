    ...
    return html.Div([
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Div([
                    html.P("As this project is applied data science, some readings which provided fundamental knowledge were not relevant to the final thesis. For this reason, I have provided an additional list of references here. These references helped towards understanding important concepts in hydrology and programming."),
                    html.Br(),
                    html.P("References:"),
                    html.Br(),
                    html.P([html.A("European Centre for River Restoration. Website. ‘Develop a strategy to manage sediment: Whitfield Moor (Peatscapes Project) Grip Blocking’", href ="https://www.ecrr.org/River-Restoration/Flood-risk-management/Healthy-Catchments-managing-for-flood-risk-WFD/Environmental-improvements-case-studies/Develop-a-strategy-to-manage-sediment", id="linkInText" ), " [last accessed: 01/07/2022]"], style={"padding-bottom": "0.5rem"}),
