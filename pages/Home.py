        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Div([
                    html.P("References:"),
                    html.Br(),
                    html.P("As this project is applied data science, some readings which provided the essential knowledge needed to begin this project was not relevant to the final thesis. For this reason, I have provided an additional list of references here. These references helped me understand important concepts in hydrology and programming. "),
                    html.Br(),
